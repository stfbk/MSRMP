                ...
                for (int i2 = 0; i2 < 8; i2++) {
                    for (int i3 = 0; i3 < 6; i3++) {
                        for (int i4 = 0; i4 < 6; i4++) {
                            double ntc = List_TC.get(0).get(i0) + List_TC.get(1).get(i1) + List_TC.get(2).get(i2) + List_TC.get(3).get(i3) + List_TC.get(4).get(i4);
                            double ntc_temp[] = null;
                            ntc_temp = new double[]{List_TC.get(0).get(i0), List_TC.get(1).get(i1), List_TC.get(2).get(i2), List_TC.get(3).get(i3), List_TC.get(4).get(i4)};
                            if (ntc > 0) {
                                if (result != null) {
